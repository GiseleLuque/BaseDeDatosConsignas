...
SELECT DISTINCT COUNT(*) AS cantidad_de_peliculas, a.address AS direccion, c.city AS ciudad, co.country AS pais FROM address a JOIN store s ON a.address_id = s.store_id
...
WHERE duracion BETWEEN 60 AND 120-- 60 = 1hora, 120 = 2horas
ORDER BY title ASC;
